@echo off
chcp 65001 > nul
:: Megafon / NetByNet / WIFIRE (Orel) - Discord via ALT11 logic + YouTube Google filters
:: Requires: setup-dns-megafon.bat OR setup-youtube-hosts.bat first (youtube.com must resolve)
