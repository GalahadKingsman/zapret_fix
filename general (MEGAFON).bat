@echo off
chcp 65001 > nul
:: Megafon / NetByNet / WIFIRE — Discord + YouTube
:: Requires: setup-dns-megafon.bat and setup-youtube-hosts.bat first
...
start "zapret-megafon" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,%GameFilterTCP% --wf-udp=443,19294-19344,50000-50100,%GameFilterUDP% ^
...
if errorlevel 1 (
    echo.
    echo [ERROR] winws.exe exited immediately.
    pause
    exit /b 1
)

echo [OK] zapret-megafon started
